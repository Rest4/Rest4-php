...
class RestVarsResponse extends RestResponse
{
  ...
  public $vars;
  public function __construct($code=RestCodes::HTTP_200, $headers=array(), $vars=null)
  {
    ...
    if ($vars instanceof stdClass) {
      ...
      throw new RestException(RestCodes::HTTP_500,
        'Given content is not an instance of stdClass.');
    } else {
  ...
  public function getContents()
  {
    ...
    case 'text/xml':
      throw new RestException(RestCodes::HTTP_501,
        'XML exports aren\'t done yet');
      $this->content=Varstream::export($this->vars);
      break;
    case 'text/html':
      throw new RestException(RestCodes::HTTP_501,
        'HTML exports aren\'t done yet');
      $this->content=Varstream::export($this->vars);
      break;
    case 'application/x-www-form-urlencoded':
      throw new RestException(RestCodes::HTTP_501,
        'URL encoded exports aren\'t done yet');
      $this->content=$this->vars;
      break;
    default:
      throw new RestException(RestCodes::HTTP_406,
        'Cannot convert datas to the asked content type (given: '
        .$this->getHeader('Content-Type')
        .', can serve: php,json,xml,html,form,dat.');
      break;
    }
