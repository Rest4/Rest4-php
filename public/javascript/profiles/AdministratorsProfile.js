var AdministratorsProfile=new Class({
	...
	prepare: function() {
		...
		this.app.menu.push({'label':locale.utils,'title':locale.utils,'childs':[
			{'label':locale.editor,'command':'openWindow:Editor','title':locale.editor_tx},
			{'label':locale.storage,'command':'adminCommands:cleanStorage','title':locale.storage_tx}
			]});
		// Registering commands
		this.app.registerCommand('adminCommands',this.webmasterCommands.bind(this));
		},
