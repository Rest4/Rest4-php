var WebmastersProfile=new Class({
	...
	prepare: function() {
		...
		this.app.menu[this.app.menu.length-1].childs.push(
			{'label':locale.db_server_label,'command':'openWindow:DbServer','title':locale.db_server_label_tx},
			{'label':locale.rest_label,'command':'openWindow:RestQuickTester','title':locale.rest_label_tx},
			{'label':locale.command_label,'command':'webmasterCommands:command','title':locale.command_label_tx},
			{'label':locale.debug_label,'command':'webmasterCommands:debug','title':this.locale.debug_label_tx},
			{'label':locale.code_label,'command':'openWindow:Code','title':locale.code_label_tx},
		...
		this.app.menu.push({'label':locale.games,'title':locale.games,'childs':[/*
			...
			{'label':locale.tank,'command':'openWindow:Browse:protocol:http:hostname:tank.elitwork.com:pathname:/index.html','title':locale.tank_tx}
			]});
		// Registering commands
		this.app.registerCommand('webmasterCommands',this.webmasterCommands.bind(this));
		},
	postChanges: function() {
		this.app.createWindow('EditorWindow',{'path':'/todo.txt'});
		},
	webmasterCommands: function(event,params)
		...
		switch(params[0])
			...
			case 'locales':
				this.app.locales=[];
				this.app.createWindow('AlertWindow',{'content':this.locale.locales_alert});
				break;
			case 'useragent':
				this.app.locales=[];
